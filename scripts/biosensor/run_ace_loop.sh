#!/bin/bash
# Continuous Ace campaign: run unlimited 50-design batches.
# Stop with Ctrl-C. Outputs are kept in unique designs/Ace_batch_* directories.
set -euo pipefail
...
TARGET_HOTSPOTS="A180,A182,A193,A195"
