#!/bin/bash
# Continuous Esp campaign: run unlimited 50-design batches.
# Stop with Ctrl-C. Outputs are kept in unique designs/Esp_batch_* directories.
set -euo pipefail
